...
export default function ProjectCard({ title, description, imageUrl, technologies = [], githubUrl = "#", liveUrl = "#" }: ProjectCardProps) {
    return (
        <div className="group relative overflow-hidden rounded-2xl border transition-transform hover:scale-[1.02] shadow-xl hover:shadow-2xl bg-white/70 border-gray-200 backdrop-blur-md dark:bg-white/10 dark:border-white/20">
